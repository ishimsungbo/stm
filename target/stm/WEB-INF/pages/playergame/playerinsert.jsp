        ...
        $(document).ready(function() {
            ...
            if(playercount==0){
                ...
                for(var i= 0, l = data.length; i < l; i++) {
                    ...
                    $('#myTable > tbody:last').append('<tr">' +
                            '<td width="10.5%"><select class="form-control" id="playerid[]"  name="playerGameVos[' + i + '].playerid"></select></td>' +
                ...
                for(var i= 0, l = upData.length; i < l; i++) {
                    ...
                    $('#myTable > tbody:last').append('<tr">' +
                            ...
                            '<td></td>'+
                            '<input type="hidden" name="playerGameVos[' + i + '].exgameid" value=' + upData[i].exgameid + '>' +
                            '</tr>'
                    );
            ...
            $('#plus').click(function(){
                ...
                $('#myTable > tbody:last').append('<tr>' +
                        ...
                        '<td width="9%"><input class="form-control text-center" id="" name="playerGameVos['+eq+'].tactics" type="number" value="0" min="0" max="10" step="1"></td>' +
