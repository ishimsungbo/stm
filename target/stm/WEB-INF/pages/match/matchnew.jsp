...
<article>
  ...
  <spring:form method="post" action="matchcreate"  name="frm" class="form-horizontal" modelAttribute="matchsVo">
    <section class="highlight_white">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input class="form-control" name="name" id="name" placeholder="필수사항" required>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <input type="text" class="form-control" id="location" name="location" placeholder="필수사항" required>
        </div>
      ...
      <div class="form-group">
          ...
          <div class="col-md-10">
            <textarea class="form-control" rows="3" name="description" id="description" placeholder="선택입력"></textarea>
          </div>
      </div>
    </section>
    ...
    <section class="highlight_white">
      <div class="form-group">
        ...
        <div class="col-md-10">
          <textarea class="form-control" rows="3" name="goal" id="goal" placeholder="(목표성적 및 대회참가 구체적 목표) 선택입력"></textarea>
        </div>
      </div>
      <div class="form-group">
        <label for="preparation" class="col-md-2 control-label">전략/전술</label>
        <div class="col-md-10">
          <textarea class="form-control" rows="3" name="preparation" id="preparation" placeholder="(대회를 위한 준비 훈련/경기) 선택입력"></textarea>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <textarea class="form-control" rows="3" name="satisfaction" id="satisfaction" placeholder="(잘된점/발전가능성) 선택입력"></textarea>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <textarea class="form-control" rows="3" name="lack" id="lack" placeholder="(반성/보완) 선택입력"></textarea>
        </div>
      </div>
    </section>
