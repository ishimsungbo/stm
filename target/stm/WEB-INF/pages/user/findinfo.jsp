    ...
    <form style="margin-top: 20px" class="form-horizontal" method="get" action="/find"  id="frm" modelAttribute="FindUserDto">
      <div class="row">
        <div class="form-group">
          <label for="email" class="col-md-3 control-label">메일주소</label>
          <div class="col-md-5">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <input id="pbtn" type="submit" value="비밀번호찾기" class="btn btn-default" style="width: 120px">
          <input id="pid" type="submit" value="아이디찾기" class="btn btn-default" style="width: 120px">
        </div>
