...
var drawingApp = (function () {
	...
	var canvas,
		...
		init = function () {
			...
			crayonImage.src = "/resources/images/crayon-outline.png";

			markerImage.onload = resourceLoaded;
			markerImage.src = "/resources/images/marker-outline.png";

			eraserImage.onload = resourceLoaded;
			eraserImage.src = "/resources/images/eraser-outline.png";

			crayonBackgroundImage.onload = resourceLoaded;
			crayonBackgroundImage.src = "/resources/images/crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "/resources/images/marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "/resources/images/eraser-background.png";

			crayonTextureImage.onload = resourceLoaded;
			crayonTextureImage.src = "/resources/images/crayon-texture.png";

			outlineImage.onload = resourceLoaded;
			outlineImage.src = "/resources/images/watermelon-duck-outline.png";
		};
