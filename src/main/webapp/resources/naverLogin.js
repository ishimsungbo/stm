...
{return null;}}
    ...
    {this.state=this.oauthParams.state;}
        ...
        {alert("�벑濡앺븳 ClientID 媛믪쓣 �엯�젰�빐 二쇱꽭�슂.");return false;}
        if((this.redirect_uri==undefined)||(this.redirect_uri=="�벑濡앺븳 Callback URL 媛�")||(this.redirect_uri.length<5))
        {alert("�벑濡앺븳 Callback URL 媛믪쓣 �엯�젰�빐 二쇱꽭�슂.");return false;}
    ...
    {alert("id 媛� naver_id_login �씤 div tag 媛� 議댁옱�빐�빞 �빀�땲�떎.");return false;}
    ...
    {alert("state 媛믪씠 留욎씠 �븡�뒿�땲�떎.");this.callback_status="warning";this.callback_message="state miss match";}}}}
    else
