...
<article>
  ...
  <section style="margin: 10px" class="highlight">
    <spring:form method="post" action="/matchgame/matchinsert"  id="frm" name="frm" cssClass="form-horizontal" commandName="gameVo">
      <div class="row">
      ...
      <div style="margin-top: 10px">
        ...
        <div class="form-group" style="margin-bottom: auto">
          ...
          <div class="col-md-4">
            <div class="input-group date form_datetime"  data-date-format="yyyy-mm-dd hh:ii" data-link-field="date">
              <input class="form-control" size="16" type="text" value="${date}"  required>
        ...
        <div class="form-group">
          ...
          <%--        <script>
                    var options = JSON.parse('${matchslist}');
