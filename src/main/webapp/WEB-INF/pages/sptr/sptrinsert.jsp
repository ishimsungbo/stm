...
<article>
  ...
  <spring:form method="post" action="create"  name="frm" class="form-horizontal" modelAttribute="SptrainingVo">
    <section class="highlight_white">
      <fieldset>
        ...
        <div class="form-group">
          <label for="efromdate" class="col-md-2 control-label">훈련기간</label>
          <div class="col-md-2">
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
            <textarea class="form-control" rows="3" name="object" id="object" required></textarea>
          </div>
        </div>
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="number" id="ballcount" name="ballcount" class="form-control" value="0" min="0" max="100" step="1">
          </div>
          <label for="conecount" class="col-md-2 control-label">꼬깔콘</label>
          <div class="col-md-2">
            <input type="number" id="conecount" name="conecount" class="form-control" value="0" min="0" max="100" step="1">
          </div>
          <label for="platecount" class="col-md-2 control-label">접시콘</label>
          <div class="col-md-2">
            <input type="number" id="platecount" name="platecount" class="form-control" value="0" min="0" max="100" step="1">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="number" id="vestuniform" name="vestuniform" class="form-control" value="0" min="0" max="100" step="1">
          </div>
          <label for="polescount" class="col-md-2 control-label">드리블봉</label>
          <div class="col-md-2">
            <input type="number" id="polescount" name="polescount" class="form-control" value="0" min="0" max="100" step="1">
          </div>
          <label for="ladder" class="col-md-2 control-label">사다리</label>
          <div class="col-md-2">
            <input type="number" id="ladder" name="ladder" class="form-control" value="0" min="0" max="100" step="1">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="number" id="roundbases" name="roundbases" class="form-control" value="0" min="0" max="100" step="1">
          </div>
          <label for="participationplayer" class="col-md-2 control-label">참여선수수</label>
          <div class="col-md-2">
            <input type="number" id="participationplayer" name="participationplayer" class="form-control" value="0" min="0" max="100" step="1">
          </div>
          <div class="col-md-4">
          </div>
        </div>
