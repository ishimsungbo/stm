...
<head>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      var trtype = '${trProgramVo.trtype}';
      $('#trtype').val(trtype);

      var exclass = '${trProgramVo.exclass}';
      $('#exclass').val(exclass);

      var injurypotential = '${trProgramVo.injurypotential}';
      $('#injurypotential').val(injurypotential);

      var importance = '${trProgramVo.importance}';
      $('#importance').val(importance);

      var strength = '${trProgramVo.strength}';
...
<article>
  <section class="page-subject">
    <h3>훈련프로그램 (보기/수정/삭제)</h3>
  </section>

  <spring:form action="/training/dbupdate" method="post" id="frm" class="form-horizontal" modelAttribute="trProgramVo">
    ...
    <section class="highlight_white">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
            <input type="text" class="form-control" id="trname" name="trname" placeholder="훈련 제목/이름" value="${trProgramVo.trname}" required>
          </div>
        </div>
      </fieldset>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <textarea class="form-control" name="description" id="description" rows="10" cols="100">${trProgramVo.description}</textarea>
        </div>
      </div>
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input type="number"  class="form-control" id="fieldermen" name="fieldermen" min="0" max="100" step="1" value="${trProgramVo.fieldermen}">
          </div>
          <label for="keepermen" class="col-md-2 control-label">골키퍼(인원)</label>
          <div class="col-md-4">
            <input type="number"  class="form-control" id="keepermen" name="keepermen" min="0" max="100" step="1" value="${trProgramVo.keepermen}">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <input type="number"  class="form-control" id="spacex" name="spacex"  step="1" value="${trProgramVo.spacex}">
          </div>
          <label for="spacey" class="col-md-2 control-label">공간:세로(meter)</label>
          <div class="col-md-4">
            <input type="number"  class="form-control" id="spacey" name="spacey"  step="1" value="${trProgramVo.spacey}">
          </div>
        </div>
      </fieldset>
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
            <textarea class="form-control" rows="3" name="trobject" id="trobject" placeholder="주요 코칭 요소 기술" required>${trProgramVo.trobject}</textarea>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <textarea class="form-control" rows="3" name="trattackobject" id="trattackobject">${trProgramVo.trattackobject}</textarea>
          </div>
          <label class="col-md-2 control-label" for="defenceobject">수비 목표</label>
          <div class="col-md-4">
            <textarea class="form-control" rows="3" name="defenceobject" id="defenceobject">${trProgramVo.defenceobject}</textarea>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <textarea class="form-control" rows="5" name="attacktactics" id="attacktactics">${trProgramVo.attacktactics}</textarea>
          </div>
          <label class="col-md-2 control-label" for="defencetactics">사용되는 수비전술</label>
          <div class="col-md-4">
            <textarea class="form-control" rows="5" name="defencetactics" id="defencetactics">${trProgramVo.defencetactics}</textarea>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <textarea class="form-control" rows="5" name="attackskill" id="attackskill">${trProgramVo.attackskill}</textarea>
          </div>
          <label class="col-md-2 control-label" for="defenceskill">사용되는 수비기술</label>
          <div class="col-md-4">
            <textarea class="form-control" rows="5" name="defenceskill" id="defenceskill">${trProgramVo.defenceskill}</textarea>
          </div>
        </div>
      </fieldset>
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-2">
            <input type="number" id="trruletime" name="trruletime" class="form-control"min="0" max="180" step="5" value="${trProgramVo.trruletime}">
          </div>
          <label class="col-md-2 control-label" for="breaktime">휴식시간</label>
          <div class="col-md-2">
            <input type="number" id="breaktime" name="breaktime" class="form-control"min="0" max="180" step="5" value="${trProgramVo.breaktime}">
          </div>
          <label class="col-md-2 control-label" for="excuteset">반복세트</label>
          <div class="col-md-2">
            <input type="number" id="excuteset" name="excuteset" class="form-control"min="0" max="10" step="1" value="${trProgramVo.excuteset}">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <textarea class="form-control" rows="2" name="youtubesource" id="youtubesource">${trProgramVo.youtubesource}</textarea>
          </div>
          <div class="col-md-2">
    ...
    <input type="hidden" id="trainingid" name="trainingid" value="${trProgramVo.trainingid}">

    <a href="/training/trmain" class="btn btn-default" style="width: 110px;">훈련목록</a>
    <input type="button" class="btn btn-default" id="savebutton" value="변경" style="width: 110px; "/>
    <a href="/training/delete?trainingid=${trProgramVo.trainingid}" class="btn btn-default" style="width: 110px">삭제</a>
  </spring:form>
</article>
